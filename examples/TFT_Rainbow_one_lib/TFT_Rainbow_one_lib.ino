...
TFT_HX8347 tft = TFT_HX8347();                   // Invoke custom library with default width and height

//TFT_HX8347 tft = TFT_HX8347(240, 320);       // Could invoke custom library declaring width and height
